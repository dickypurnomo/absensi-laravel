                ...
                <form action="/dashboard/employees/{{ $user->id }}" method="POST">
                    ...
                    @csrf
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="name" name="name" placeholder="John Martin" required value="{{ old('name', $user->name) }}">
                        </div>
                        </div>
                        <div class="row">
                        <div class="mb-3">
                          <label for="address" class="form-label">Address</label>
                          <input type="text" class="form-control" id="address" name="address" placeholder="123 Road Race" value="{{ old('address', $user->address) }}">
                        </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="phonenumber" name="phonenumber" placeholder="+62123123123" value="{{ old('phonenumber', $user->phonenumber) }}"required>
                        </div>
                        </div>
                        <div class="row">
                        <div class="mb-3 col-6">
                          <label for="email" class="form-label">Email</label>
                          <input type="text" class="form-control" id="email" name="email" placeholder="johnmartin@mail.com" value="{{ old('email', $user->email) }}" required>
                        </div>
                        <div class="mb-3 col-6">
                    ...
                    <button class="btn btn-dark py-2 mt-3" type="submit">Update Employee</button>
                </form>
                </div>
                </div>
          </div>
